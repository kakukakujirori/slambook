...
int main(int argc, char **argv) {
    Matrix3d rotation_matrix = Matrix3d::Identity();  // 3D rotation matrix directly using Matrix3d of Matrix3f
    ...
    rotation_matrix = rotation_vector.toRotationMatrix(); // can also be assigned directly

    // cordinate transformation with AngleAxis
    Vector3d v(1, 0, 0);
    ...
    // Quatenion
    // You can assign AngleAxis directly to quartenions, and vice versa
