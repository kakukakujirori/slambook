...
void Backend::BackendLoop() {
    while (backend_running_.load()) {
        ...
        // Back-end optimization of only active Frames and Landmarks
...
void Backend::Optimize(Map::KeyframesType &keyframes,
    ...
    // landmark vertices, using the landmark id
    std::map<unsigned long, VertexXYZ *> vertices_landmarks;

    // K and the left and right external parameters
    Mat33 K = cam_left_->K();
    ...
    for (auto &landmark : landmarks) {
        ...
        for (auto &obs : observations) {
            ...
            // If landmark has not been added for optimization, add a new vertex
